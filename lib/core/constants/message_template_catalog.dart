...
abstract final class MessageTemplateCatalog {
  ...
  static MessageTemplateOption? byKey(String key) {
  ...
  static List<MessageTemplateOption> bySection(MessageTemplateSection section) {
    return options.where((option) => option.section == section).toList();
  }
}
